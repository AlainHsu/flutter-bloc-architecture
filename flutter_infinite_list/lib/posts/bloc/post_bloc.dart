...
class PostBloc extends Bloc<PostEvent, PostState> {
  ...
  Stream<PostState> mapEventToState(
    ...
    if (event is PostFetched) {
      ...
      yield PostState();
      yield await _mapPostRefreshedToState(state);
    }
  }

  Future<PostState> _mapPostRefreshedToState(PostState state) async {
    try {
      final post = await _fetchPosts();
      return state.copyWith(
          status: PostStatus.success, posts: post, hasReachedMax: false);
    } on Exception {
